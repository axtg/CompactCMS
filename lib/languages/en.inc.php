...
$ccms['lang']['system']['error_selection'] 	= "No file was selected.";
...
$ccms['lang']['backend']['confirmdelete'] 	= "Please confirm that you want to delete the selected item(s) and all contents.";
...
$ccms['lang']['backend']['managefiles'] 	= "Manage current files";
